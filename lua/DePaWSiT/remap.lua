...
local map = {
  ...
  RUN_TEST_NEAR_DAP = "<leader>tdr",
  RUN_TEST_FILE_DAP = "<leader>tdf",
  STOP_TEST = "<leader>tq",
  OPEN_TEST_OUTPUT = "<leader>to",
  OPEN_TEST_PANEL = "<leader>tpo",
  CLOSE_TEST_PANEL = "<leader>tpq",
  CLEAR_TEST_PANEL = "<leader>tpc",
  OPEN_TEST_SUMMARY = "<leader>tso",
  CLOSE_TEST_SUMMARY = "<leader>tsq",
  RUN_MARKED_TESTS = "<leader>tmr",
  CLEAR_MARKED_TESTS = "<leader>tmc",
  --Snacks
  SHOW_BUFFERS = "<leader>,",
